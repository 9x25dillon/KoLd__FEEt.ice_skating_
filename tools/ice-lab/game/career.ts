...
import { makeProfile, train, xpToRaise, STAT_NAMES } from "../sim/profile.ts";
...
export class CareerState {
  ...
  get unlocked() { const next = this.medals.findIndex(m => m === 0); return next < 0 ? CAREER_EVENTS.length - 1 : next; }
