...
export function schemeA(c: Controls): SkatingInput {
  return {
    ...
    carriage: carriage(c), toe: c.toe, turn: c.turn, twizzle: c.twizzle, spin: c.spin,
  };
}
...
export function schemeC(c: Controls): SkatingInput {
  ...
  return {
    ...
    carriage: clamp(c.carriage, 0, 1), toe: c.toe, turn: c.turn, twizzle: c.twizzle, spin: c.spin,
  };
}
